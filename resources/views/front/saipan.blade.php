...
@section('content')
<!-- Page banner start -->
<div class="page-banner" style="background-image: url({{ $saipan_page ? $saipan_page->page_banner_image : asset('front/images/page-banner-bg.png') }})">
    <div class="container">
        <h1>Our Saipan</h1>
        <span>Home / Saipan</span>
    </div>
</div>
<!-- Page banner end -->
...
<section class="service">
    <div class="container">
        <div class="section-title text-center title-margin">
            @if ($saipan_page)
            <h2>{{ $saipan_page->saipan_title }}</h2>
            <p class="m-auto">{!! $saipan_page->saipan_description !!}</p>
            @endif
        </div>
        <div class="row">
