            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-2">Direct contact list</h4>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="dataForm" class="form" action="{{ route('contact.index.update') }}" method="POST">
                    @csrf
                    <div class="form-body">
                      <div class="row">
                        <div class="col-lg-12">
                            <fieldset class="form-group">
                              <label for="taxi">Change status</label>
        ...
        e.preventDefault();
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        method: "GET",
                        url: '{{ route('contact.index.delete') }}',
                        data: {
