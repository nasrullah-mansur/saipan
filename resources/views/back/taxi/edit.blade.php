            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Taxi Item Update</h4>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                            <form method="POST" action="{{ route('admin.taxi.update', $taxi->id) }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <fieldset class="form-group">
                                          <label for="heading">Title</label>
                                          <input name="title" type="text" class="form-control" id="heading" value="{{ $taxi->title }}">
                                          @if($errors->has('title'))
                                    ...
                                    <div class="col-12">
                                        <fieldset class="form-group">
                                          ...
                                          <input name="sub_title" type="text" class="form-control" id="sub_title" value="{{ $taxi->sub_title }}">
                                    ...
                                    <div class="col-12">
                                        <fieldset class="form-group">
                                          ...
                                          <input name="from" type="text" class="form-control" id="from" value="{{ $taxi->from }}">
                                          @if($errors->has('from'))
                                    ...
                                    <div class="col-12">
                                        <fieldset class="form-group">
                                          ...
                                          <textarea name="description" class="form-control w-100" id="description" rows="6">{{ $taxi->description }}</textarea>
                                    ...
                                    <div class="col-lg-6">
                                        <fieldset class="form-group">
                                          ...
                                          <select name="pick_up_id" class="form-control" id="pick_up">
                                            ...
                                            <option {{ $taxi->pick_up_id == $taxi->id ? 'selected' : '' }} value="{{ $pickup->id }}">{{ $pickup->title }}</option>
                                            @endforeach
                                          </select>
                                        </fieldset>
                                    </div>
                                    <div class="col-lg-6">
                                        <fieldset class="form-group">
                                          ...
                                          <select name="drop_off_id" class="form-control" id="drop_of">
                                            ...
                                            <option {{ $taxi->drop_off_id == $taxi->id ? 'selected' : '' }} value="{{ $dropoff->id }}">{{ $dropoff->title }}</option>
                                            @endforeach
                                          </select>
                                        </fieldset>
                                    </div>
                                        ...
                                        <div class="card-content  collapse show">
                                            ...
                                            <div class="repeater-default">
                                                <div data-repeater-list="features">
                                                    @foreach (json_decode($taxi->features) as $feature)
                                                    <div data-repeater-item>
                                                        <div class="row">
                                                            <div class="form-group mb-1 col-sm-12 col-md-4">
                                                                <label>Name</label>
                                                                <br>
                                                                <input name="name" type="text" class="form-control" placeholder="Name" value="{{ $feature->name }}">
                                                            </div>
                                                            <div class="form-group mb-1 col-sm-12 col-md-4">
                                                                <label>Value</label>
                                                                <br>
                                                                <input name="value" type="text" class="form-control" placeholder="Value" value="{{ $feature->value }}">
                                                            </div>
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <fieldset class="form-group">
                                            <div class="preview_img d-block">
                                                <img width="120" src="{{ asset($taxi->image ? $taxi->image : 'demo.jpg') }}" alt="demo">
                                            </div>
