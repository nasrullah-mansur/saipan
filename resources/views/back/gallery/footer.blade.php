    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="dataForm" class="form" action="{{ route('admin.gallery.footer.create') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-body">
                      <div class="row">
                        <div class="col-lg-6 col-md-12">
                            <fieldset class="form-group">
                                ...
                                <label for="basicSelect">Choose gallery image (130*110)</label>
...
<script>
        ...
        e.preventDefault();
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        method: "GET",
                        url: '{{ route('admin.gallery.footer.delete') }}',
                        data: {
    ...
    $('.table-area').on('click', '.edit-btn', function(e){
        ...
        $('#addModal').modal('show');
        $('#dataForm').attr('action', "{{ route('admin.gallery.footer.update') }}");
        $('[name="alt"]').val(alt);
    ...
    $('#addItemBtn').on('click', function(e) {
        ...
        $('#addModal form')[0].reset();
        $('.preview_img').hide();
        $('#dataForm').attr('action', "{{ route('admin.gallery.footer.create') }}");
    })
