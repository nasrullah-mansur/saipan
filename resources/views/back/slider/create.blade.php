                                ...
                                <div class="row">
                                    <div class="col-12 mb-1">
                                        <fieldset class="form-group">
                                          ...
                                          <input name="header" type="text" class="form-control" id="heading">
                                    ...
                                    <div class="col-12">
                                        <fieldset class="form-group">
                                          ...
                                          <textarea name="content" class="form-control w-100" id="content" rows="3"></textarea>
                                    ...
                                    <div class="col-lg-6">
                                        <fieldset class="form-group">
                                          ...
                                          <select name="btn" class="form-control" id="basicSelect">
                                            <option value="taxi">Taxi page</option>
                                            <option value="saipan">Saipan page</option>
