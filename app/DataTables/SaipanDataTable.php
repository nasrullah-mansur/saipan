...
class SaipanDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->editColumn('action', function($data) {
            ...
            '<div class="d-flex action-btn">
                <a data-id="'.$data->id.'" class="btn btn-icon '. $btn['class_name'] .' delete-btn" href="' . route('saipan.single', $data->slug) . '" target="_blank"><i class="ft-eye"></i></a>
                <a data-id="'.$data->id.'" class="btn btn-icon '. $btn['class_name'] .' delete-btn" href="' . route('admin.saipan.edit', $data->id) . '">'. $btn['icon'] .'</a>
     ...
     *
     * @param \App\Models\Saipan $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Saipan $model): QueryBuilder
    {
