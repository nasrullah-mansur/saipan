...
class SaipanGalleryDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->editColumn('action', function($data) {
            ...
            '<div class="d-flex action-btn">
                <a data-id="'.$data->id.'" data-saipan_id="'.$data->saipan_id.'" class="btn btn-icon '. $btn['class_name'] .' delete-btn" href="#">'. $btn['icon'] .'</a>
     ...
     *
     * @param \App\Models\SaipanGallery $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(SaipanGallery $model): QueryBuilder
    {
    ...
    protected function getColumns(): array
    {
        return [
            ...
            Column::make('image'),
            Column::make('alt'),
            Column::make(['name' => 'saipan_id', 'title' => 'Image For', 'data' => 'saipan_id'])->searchable(false),
    ...
    {
        return 'SaipanGallery_' . date('YmdHis');
    }
}
