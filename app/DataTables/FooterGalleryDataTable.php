...
class FooterGalleryDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\FooterGallery $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(FooterGallery $model): QueryBuilder
    {
    ...
    {
        return 'FooterGallery_' . date('YmdHis');
    }
}
